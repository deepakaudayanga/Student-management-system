...
{
    public partial class RStaff : Form
    {
        OleDbConnection con = new OleDbConnection(@"Provider = Microsoft.ACE.OLEDB.12.0; Data Source = staff.accdb");
        int cheker;
        Bitmap bitmap;
        public RStaff()
        {
        ...
        private void RStaff_Load(object sender, EventArgs e)
        {
            dataviewer();
        }
        ...
        private void BtnAdd_Click_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                OleDbCommand cmd = con.CreateCommand();
                cmd.CommandType = CommandType.Text;
                cmd.CommandText = "Insert Into staff(StaffID,FristName,LastName,Address,PostelCode,PhoneNum,Gender,BirthDay) Values ('" + textID.Text + "', '" + textFName.Text + "','" + textLName.Text + "','" + textAddress.Text + "','" + textPostel.Text + "','" + textPhone.Text + "','" + textGender.Text + "','" + textBirthDay.Text + "'  )";
                cmd.ExecuteNonQuery();
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                OleDbCommand cmd = con.CreateCommand();
                cmd.CommandType = CommandType.Text;
                cmd.CommandText = " update staff set StaffID= '" + textID.Text + "' where FristName= '" + textFName.Text + "'and LastName= '" + textLName.Text + "'";
                cmd.ExecuteNonQuery();
                con.Close();
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                OleDbCommand cmd = con.CreateCommand();
                cmd.CommandType = CommandType.Text;
                cmd.CommandText = " delete * from staff where StaffID= '" + textID.Text + "'";
                cmd.ExecuteNonQuery();
                con.Close();
        ...
        private void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                OleDbCommand cmd = con.CreateCommand();
                cmd.CommandType = CommandType.Text;
                cmd.CommandText = " select *from staff where StaffID= '" + textSeach.Text + "' or FristName='" + textSeach.Text + "' or LastName='" + textSeach.Text + "'  ";
                cmd.ExecuteNonQuery();
